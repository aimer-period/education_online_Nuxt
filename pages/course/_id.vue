      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section id="videoPlay" class="p-h-video-box">
            <img :src="course.cover" :alt="course.title"  style="width: 500px;height:350px;" class="dis c-v-pic">
          </section>
        </article>
...
export default {
  ...
  created() {
    ...
    courseAPI.getById(this.$route.params.id).then(response => {
